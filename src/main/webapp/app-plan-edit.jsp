            ...
            <form action="/app/plan/edit" method="post">
                ...
                <div class="schedules-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="${planID.name}" id="planName" placeholder="Nazwa planu" name="planName">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                                        <textarea class="form-control" rows="5" id="planDescription" placeholder="Opis plany" name="planDescription">${planID.description}</textarea>
                        </div>
                    </div>
