                    ...
                    <table class="table border-bottom">
                        ...
                        <c:forEach items="${sessionScope.plans}" var="plan">
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    <c:out value="${plan.description}"/></td>
                                <td class="col-2 d-flex align-items-center justify-content-center flex-wrap"><a data-href="/app/plan/delete?id=${plan.id}" data-message="Czy na pewno chcesz usunąć plan?" class="btn btn-danger rounded-0 text-light m-1 deletion-confirmation">Usuń</a>
